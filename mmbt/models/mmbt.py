...
class MultimodalBertEncoder(BasePLModel):
    def __init__(self, args):
        super(MultimodalBertEncoder, self).__init__(args)
        self.args = args
...
class MultimodalBertClf(BasePLModel):
    def __init__(self, args):
        super(MultimodalBertClf, self).__init__(args)
        self.args = args
